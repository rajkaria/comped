...
|---|---|---|
| `report` | root | `python3 resources/micro_core/cli.py last-turn report --claude-dir $claude_dir --codex-dir $codex_dir --rates-path $rates_path --tz $tz --now $now --demo $demo` |
