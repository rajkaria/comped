...
class TextNormTests(unittest.TestCase):
    ...
    def test_exclusions(self):
        ...
        self.assertEqual(is_excluded(H("This session is being continued from a previous conversation that ran out of context. The conversation is summarized below:")), "continuation")
        self.assertEqual(is_excluded(H("Caveat: The messages below were generated by the user while running local commands.")), "harness-notice")
